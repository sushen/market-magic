<div class="rtmedia-container">
    ...
    <?php if ( have_rtmedia() ) { ?>
        <ul class="rtmedia-list rtmedia-list-media rtm-gallery-list animate-when-almost-visible one-by-one-general clearfix <?php echo rtmedia_media_gallery_class(); ?>">
